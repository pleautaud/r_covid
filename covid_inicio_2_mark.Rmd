...
```{r eval=TRUE}
datos <- read.csv("200529COVID19MEXICO.csv", header = TRUE, encoding = "UTF-8")
datos2 <- datos
datos2$Num <- 1
```
...
g_alc_cmx <- ggline(resumen_cmx_t2,"FECHA_INGRESO", "value", shape = "variable", color = "variable",
                    ...
                    subtitle = "Considerando los casos positivios detectados en los últimos 15 días",
...
g_alc_cmx_100k <- ggline(resumen_cmx_t_100k2,"FECHA_INGRESO", "value", shape = "variable", color = "variable", 
                    title = "Evolución de los casos SARS-CoV2 activos en las alcaldías de la CDMX", 
                    subtitle = "Considerando los casos positivios detectados en los últimos 15 días",
                    xlab = "Fecha", ylab = "Casos activos acumulados (por cada 100 mil habitantes)", ggtheme = theme_light(), 
                    legend.title = "Alcaldía")
g_alc_cmx_100k
```
